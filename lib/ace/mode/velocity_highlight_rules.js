...
var VelocityHighlightRules = function() {
    ...
    var builtinFunctions = lang.arrayToMap(
        ("_DateTool|_DisplayTool|_EscapeTool|_FieldTool|_MathTool|_NumberTool|_PropertyTool|_SerializerTool|_SortTool|_StringTool|_XPathTool|"+
        "locateBlock|locateFile|locateFolder|locatePage|locateReference|locateSymlink|locate"
        ).split('|')
    );

    var builtinVariables = lang.arrayToMap(
        ('$contentRoot|$currentPagePath|$currentPageSiteName|$foreach').split('|')
    );

    var keywords = lang.arrayToMap(
        ("#set|#macro|#include|#import|#parse|" +
